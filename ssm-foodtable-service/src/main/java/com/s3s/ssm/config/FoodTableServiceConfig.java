...
import com.s3s.ssm.service.foodtable.IAreaService;
import com.s3s.ssm.service.foodtable.IFoodTableService;

@Configuration
@EnableAutoConfiguration
@Import(InfrastructureConfig.class)
@ComponentScan(basePackages = "com.s3s.ssm.service.foodtable")
@EnableJpaRepositories(basePackages = "com.s3s.ssm.repo.foodtable")
public class FoodTableServiceConfig {
  @Autowired
